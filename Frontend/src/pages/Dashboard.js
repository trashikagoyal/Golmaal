  ...
  return (
    <>
      <div className="grid grid-cols-1 col-span-12 lg:col-span-10 gap-6 md:grid-cols-3 lg:grid-cols-4  p-4 ">
        ...
        <div className="flex justify-around bg-white rounded-lg py-8 col-span-full justify-center">
        <div>
          <Chart options={chart.options} series={chart.series} type="bar" height={400} width={600} />
        </div>
...
//   // Fetching total sales amount
//   const fetchTotalSaleAmount = () => {
//     fetch(`http://localhost:4000/api/sales/get/${authContext.user}/total`)
//       .then((response) => response.json())
//       .then((data) => setSaleAmount(data.totalSaleAmount))
//       .catch((err) => console.error("Error fetching total sale amount:", err));
//   };

//   // Fetching total purchase amount
//   const fetchTotalPurchaseAmount = () => {
//     fetch(`http://localhost:4000/api/purchase/get/${authContext.user}/total`)
//       .then((response) => response.json())
//       .then((data) => setPurchaseAmount(data.totalPurchaseAmount))
//       .catch((err) => console.error("Error fetching total purchase amount:", err));
//   };
...
//           <p>
//             <span className="text-2xl font-medium text-gray-900">${saleAmount}</span>
//             <span className="text-xs text-gray-500"> from $240.94</span>
//           </p>
//         </div>
//       </article>
...
//           <p>
//             <span className="text-2xl font-medium text-gray-900">${purchaseAmount}</span>
//             <span className="text-xs text-gray-500"> from $404.32</span>
//           </p>
//         </div>
//       </article>
...
//           <p>
//             <span className="text-2xl font-medium text-gray-900">{products.length}</span>
//           </p>
//         </div>
//       </article>
...
//           <p>
//             <span className="text-2xl font-medium text-gray-900">{stores.length}</span>
//           </p>
//         </div>
//       </article>
